...
!function t(e, i, n) {
            ...
            function n() {
                ...
                t.each(function(t, i) {
                    ...
                    a.on("click.accordion.amui", function() {
                        ...
                        s.is(e.disabled) || (s.toggleClass("am-active"),
                        a ? t.collapse("toggle") : t.collapse(),
                        !n.multiple && o(i).children(".am-active").not(s).not(e.disabled).removeClass("am-active").find(e.body + ".am-in").collapse("close"))
                    })
                })
            }
            t("./core"),
    ...
    4: [function(t, e) {
        (function(t) {
            ...
            n.utils.isInView = function(t, e) {
                ...
                u + n.height() >= r && u - e.topOffset <= r + o.height() && c + n.width() >= a && c - e.leftOffset <= a + o.width()
            }
            ,
            ...
            i.fn.alterClass = function(t, e) {
                ...
                return n.each(function(t, e) {
                    for (var n = " " + e.className + " "; o.test(n); )
                        n = n.replace(o, " ");
            ...
            i(function() {
                var t = n.FastClick;
                t && (i("[contenteditable]").addClass("needsclick"),
            ...
            i(function() {
                var t = i("body");
                n.DOMReady = !0,
                i.each(n.DOMWatchers, function(t, e) {
                    e(document)
                }),
    ...
    8: [function(t, e) {
        (function(i) {
            ...
            function n() {
                ...
                t.addToHS && a(),
                o('[data-rel="desktop"]').on("click", function(t) {
                    t.preventDefault(),
    ...
    10: [function(t, e) {
        (function(i) {
            ...
            function n() {
                ...
                t(),
                n.on("scroll.gotop.amui", o.AMUI.utils.debounce(t, 100))
            }
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null ;
            t("./core"),
            t("./ui.smooth-scroll"),
        ...
        (function(i) {
            ...
            function n() {
                o('[data-am-widget="header"]').each(function() {
                    return o(this).hasClass("am-header-fixed") ? (o("body").addClass("am-with-fixed-header"),
                    !1) : void 0
                })
            }
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null ;
        ...
        (function(i) {
            ...
            function o() {
                ...
                s == e && a == i ? f.getPoint(o, function(t) {
                    ...
                    d.setPosition(u),
                    c.addOverlay(d),
                    o ? c.openInfoWindow(p, u) : c.openInfoWindow(new BMap.InfoWindow(o,h), u)
                })
            }
              ...
              , s = function() {
                ...
                t.filter(".am-menu-one").each(function(t) {
                    ...
                    l.on("click", function() {
                        ...
                        (a ? u.left + u.width > d.left + d.width : u.left < d.left) && (o = r.offset(),
                        c.scrollTo(a ? d.width - u.left + o.left - u.width - h : o.left - u.left, 0, 400)),
                        e = n(this).index()
                    }),
    ...
    23: [function(t, e) {
        (function(i) {
            ...
            o.Class = function(t) {
                ...
                this.options.debug && (o.isCompatible = !0,
                o.OS = "string" == typeof this.options.debug ? this.options.debug : "unsupported" == o.OS ? "android" : o.OS,
                o.OSVersion = "ios" == o.OS ? "8" : "4"),
                this.container = document.documentElement,
                this.session = localStorage.getItem(this.options.appID),
                this.session = this.session ? JSON.parse(this.session) : void 0,
                !o.hasToken || o.isCompatible && this.session || (o.hasToken = !1,
                a()),
                o.isCompatible) {
                    ...
                    !this.session.optedout && !this.session.added && i) {
                        if (o.isStandalone)
                            return void (this.session.added || (this.session.added = !0,
                            this.updateSession(),
                            this.options.onAdd && o.hasLocalStorage && this.options.onAdd.call(this)));
                        if (this.options.detectHomescreen) {
                            if (o.hasToken)
                                return a(),
                                void (this.session.added || (this.session.added = !0,
                                this.updateSession(),
                                this.options.onAdd && o.hasLocalStorage && this.options.onAdd.call(this)));
                        ...
                        (this.session.returningVisitor || (this.session.returningVisitor = !0,
                        this.updateSession(),
                        !this.options.skipFirstVisit)) && o.hasLocalStorage && (this.ready = !0,
                        this.options.onInit && this.options.onInit.call(this),
                        this.options.autostart && this.show())
                    }
                }
            }
            ,
    ...
    25: [function(t, e) {
        (function(i) {
            ...
            a.prototype.setState = function(t) {
                ...
                s.support.animation && n.spinner && "html" === a && !this.hasSpinner && (n.loadingText = '<span class="am-icon-' + n.spinner + ' am-icon-spin"></span>' + n.loadingText,
                this.hasSpinner = !0),
                i[a](n[t]),
                setTimeout(o.proxy(function() {
                    "loadingText" == t ? (i.addClass(r).attr(e, e),
                    this.isLoading = !0) : this.isLoading && (i.removeClass(r).removeAttr(e),
                    this.isLoading = !1)
                }, this), 0)
            }
            ,
            ...
            ,
            o.fn.button = n,
            o(document).on("click.button.amui.data-api", "[data-am-button]", function(t) {
                var e = o(t.target);
    ...
    26: [function(t, e) {
        (function(i) {
            ...
            ,
            o.fn.collapse = n,
            o(document).on("click.collapse.amui.data-api", "[data-am-collapse]", function(t) {
                ...
                c && c.transitioning || (h && h.find("[data-am-collapse]").not(i).addClass("am-collapsed"),
    ...
    27: [function(t, e) {
        (function(i) {
            ...
            a.prototype.fill = function() {
                ...
                c = c.valueOf();
                for (var u, d, h, p = []; o.valueOf() < c; )
                    o.getDay() === this.weekStart && p.push("<tr>"),
                    u = this.onRender(o),
                    d = o.getFullYear(),
                    h = o.getMonth(),
                    i > h && d === e || e > d ? u += " am-datepicker-old" : (h > i && d === e || d > e) && (u += " am-datepicker-new"),
                ...
                for (var v = 0; 12 > v; )
                    this.onRender(t.setFullYear(e, v)) && m.eq(v).addClass("am-disabled"),
                    v++;
                ...
                e -= 1;
                for (var y = -1; 11 > y; y++)
                    g = this.onRender(t.setFullYear(e)),
            ...
            a.prototype.click = function(t) {
                ...
                if (1 === l.length)
                    ...
                    case "span":
                        ...
                        l.is(".am-active") ? this.viewDate.setMonth(e, o.text()) : this.viewDate.setMonth(e)) : (i = parseInt(l.text(), 10) || 0,
                        l.is(".am-active") ? this.viewDate.setFullYear(i, a, o.text()) : this.viewDate.setFullYear(i)),
            ...
            var r = {
                ...
                parseDate: function(t, e) {
                    ...
                    n.length === e.parts.length) {
                        for (var o = t.getFullYear(), s = t.getDate(), a = t.getMonth(), r = 0, l = e.parts.length; l > r; r++)
                ...
                formatDate: function(t, e) {
                    ...
                    i.dd = (i.d < 10 ? "0" : "") + i.d,
                    i.mm = (i.m < 10 ? "0" : "") + i.m;
                    for (var o = 0, s = e.parts.length; s > o; o++)
                        n.push(i[e.parts[o]]);
        ...
        (function(i) {
            ...
            r.prototype.open = function() {
                ...
                if (!t.is(".am-disabled, :disabled") && !this.active) {
                    ...
                    a ? (this.animating = 1,
                    i.addClass(this.options.animation).on(a.end + ".open.dropdown.amui", o.proxy(function() {
                        n(),
            ...
            r.prototype.close = function() {
                if (this.active) {
                    ...
                    a ? (i.removeClass(this.options.animation),
                    i.addClass(t),
                    this.animating = 1,
                    i.one(a.end + ".close.dropdown.amui", function() {
                        i.removeClass(t),
                        n()
                    })) : n()
                }
            ...
            n.flexslider = function(t, e) {
                ...
                m = {
                    init: function() {
                        ...
                        i.started = !1,
                        i.startTimeout = null ,
                        i.transitions = !i.vars.video && !p && i.vars.useCSS && function() {
                        ...
                        i.vars.keyboard && (1 === n(i.containerSelector).length || i.vars.multipleKeyboard) && n(document).bind("keyup", function(t) {
                            var e = t.keyCode;
                        ...
                        setup: function() {
                            ...
                            i.slides.each(function() {
                                ...
                                t.addEventListener("MSGestureTap", function(t) {
                                    ...
                                    var e = n(this)
                                      , o = e.index();
                                    n(i.vars.asNavFor).data("flexslider").animating || e.hasClass("active") || (i.direction = i.currentItem < o ? "next" : "prev",
                                ...
                                0 >= a && e.hasClass(s + "active-slide") ? i.flexAnimate(i.getTarget("prev"), !0) : n(i.vars.asNavFor).data("flexslider").animating || e.hasClass(s + "active-slide") || (i.direction = i.currentItem < o ? "next" : "prev",
                                i.flexAnimate(o, i.vars.pauseOnAction, !1, !0, !0))
                            })
                        }
                    },
                    controlNav: {
                        ...
                        setupPaging: function() {
                            ...
                            if (i.controlNavScaffold = n('<ol class="' + s + "control-nav " + s + o + '"></ol>'),
                            i.pagingCount > 1)
                                for (var r = 0; r < i.pagingCount; r++) {
                                    if (e = i.slides.eq(r),
                                    t = "thumbnails" === i.vars.controlNav ? '<img src="' + e.attr("data-thumb") + '"/>' : "<a>" + a + "</a>",
                            ...
                            i.controlNavScaffold.delegate("a, img", l, function(t) {
                                ...
                                "" === c || c === t.type) {
                                    ...
                                    e.hasClass(s + "active") || (i.direction = o > i.currentSlide ? "next" : "prev",
                    ...
                    directionNav: {
                        setup: function() {
                            ...
                            i.controlsContainer ? (n(i.controlsContainer).append(t),
                            i.directionNav = n("." + s + "direction-nav li a", i.controlsContainer)) : (i.append(t),
                            i.directionNav = n("." + s + "direction-nav li a", i)),
                            m.directionNav.update(),
                            i.directionNav.bind(l, function(t) {
                                t.preventDefault();
                                var e;
                                ("" === c || c === t.type) && (e = i.getTarget(n(this).hasClass(s + "next") ? "next" : "prev"),
                    ...
                    pausePlay: {
                        setup: function() {
                            ...
                            i.pausePlay = n("." + s + "pauseplay a", i.controlsContainer)) : (i.append(t),
                            i.pausePlay = n("." + s + "pauseplay a", i)),
                            m.pausePlay.update(i.vars.slideshow ? s + "pause" : s + "play"),
                            i.pausePlay.bind(l, function(t) {
                                t.preventDefault(),
                                ("" === c || c === t.type) && (n(this).hasClass(s + "pause") ? (i.manualPause = !0,
                                i.manualPlay = !1,
                    ...
                    touch: function() {
                        function e(e) {
                            ...
                            b = e.touches[0].pageX,
                            T = e.touches[0].pageY,
                            m = h && d && i.animatingTo === i.last ? 0 : h && d ? i.limit - (i.itemW + i.vars.itemMargin) * i.move * i.animatingTo : h && i.currentSlide === i.last ? i.limit : h ? (i.itemW + i.vars.itemMargin) * i.move * i.currentSlide : d ? (i.last - i.currentSlide + i.cloneOffset) * v : (i.currentSlide + i.cloneOffset) * v,
                            c = u ? T : b,
                            f = u ? b : T,
                        ...
                        function n(t) {
                            ...
                            var e = 500;
                            (!y || Number(new Date) - w > e) && (t.preventDefault(),
                            !p && i.transitions && (i.vars.animationLoop || (g /= 0 === i.currentSlide && 0 > g || i.currentSlide === i.last && g > 0 ? Math.abs(g) / v + 2 : 1),
                            i.setProps(m + g, "setTouch")))
                        }
                        function o() {
                            if (t.removeEventListener("touchmove", n, !1),
                            i.animatingTo === i.currentSlide && !y && null !== g) {
                                var e = d ? -g : g
                        ...
                        function r(e) {
                            ...
                            if (i) {
                                ...
                                e.detail === e.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                                    t._gesture.stop()
                                }) : void ((!y || Number(new Date) - w > 500) && (e.preventDefault(),
                                !p && i.transitions && (i.vars.animationLoop || (g = x / (0 === i.currentSlide && 0 > x || i.currentSlide === i.last && x > 0 ? Math.abs(x) / v + 2 : 1)),
                                i.setProps(m + g, "setTouch"))))
                            }
                        }
                        function l(t) {
                    ...
                    resize: function() {
                        !i.animating && i.is(":visible") && (h || i.doMath(),
                        p ? m.smoothHeight() : h ? (i.slides.width(i.computedW),
                ...
                i.flexAnimate = function(t, e, o, a, l) {
                    ...
                    !i.animating && (i.canAdvance(t, l) || o) && i.is(":visible")) {
                        if (f && a) {
                        ...
                        p)
                            ...
                            h ? (v = i.vars.itemMargin,
                            w = (i.itemW + v) * i.move * i.animatingTo,
                            g = w > i.limit && 1 !== i.visible ? i.limit : w) : g = 0 === i.currentSlide && t === i.count - 1 && i.vars.animationLoop && "next" !== i.direction ? d ? (i.count + i.cloneOffset) * y : 0 : i.currentSlide === i.last && 0 === t && i.vars.animationLoop && "prev" !== i.direction ? d ? 0 : (i.count + 1) * y : d ? (i.count - 1 - t + i.cloneOffset) * y : (t + i.cloneOffset) * y,
                ...
                i.setProps = function(t, e, n) {
                    ...
                    i.transitions && (o = u ? "translate3d(0," + o + ",0)" : "translate3d(" + o + ",0,0)",
                ...
                i.setup = function(t) {
                    if (p)
                        ...
                        i.cloneCount = 0,
                        i.cloneOffset = 0,
                        d && (o = n.makeArray(i.slides).reverse(),
                        i.slides = n(o),
                        i.container.empty().append(i.slides))),
                        i.vars.animationLoop && !h && (i.cloneCount = 2,
                        i.cloneOffset = 1,
                        ...
                        u && !h ? (i.container.height(200 * (i.count + i.cloneCount) + "%").css("position", "absolute").width("100%"),
                        setTimeout(function() {
                            i.newSlides.css({
                                display: "block"
                            }),
                ...
                i.update = function(t, e) {
                    i.doMath(),
                    h || (t < i.currentSlide ? i.currentSlide += 1 : t <= i.currentSlide && 0 !== t && (i.currentSlide -= 1),
                    i.animatingTo = i.currentSlide),
                    i.vars.controlNav && !i.manualControls && ("add" === e && !h || i.pagingCount > i.controlNav.length ? m.controlNav.update("add") : ("remove" === e && !h || i.pagingCount < i.controlNav.length) && (h && i.currentSlide > i.last && (i.currentSlide -= 1,
                    i.animatingTo -= 1),
                ...
                i.addSlide = function(t, e) {
                    ...
                    i.count += 1,
                    i.last = i.count - 1,
                    u && d ? void 0 !== e ? i.slides.eq(i.count - e).after(o) : i.container.prepend(o) : void 0 !== e ? i.slides.eq(e).before(o) : i.container.append(o),
                    i.update(e, "add"),
                ...
                i.removeSlide = function(t) {
                    ...
                    i.count -= 1,
                    i.last = i.count - 1,
                    isNaN(t) ? n(t, i.slides).remove() : u && d ? i.slides.eq(i.last).remove() : i.slides.eq(t).remove(),
                    i.doMath(),
                    i.update(e, "remove"),
                    i.slides = n(i.vars.selector + ":not(.clone)", i),
                    i.setup(),
                ...
                "object" == typeof t)
                    return this.each(function() {
                        var e = n(this)
                          ...
                          , o = e.find(i);
                        1 === o.length && t.allowOneSlide === !0 || 0 === o.length ? (o.fadeIn(400),
            ...
            window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
              ...
              , a = function() {
                ...
                e.momentum = function(t, e, i, n, o, s) {
                    ...
                    a = t + c * c / (2 * s) * (0 > l ? -1 : 1),
                    r = c / s,
                    n > a ? (a = o ? n - o / 2.5 * (c / 8) : n,
                    l = Math.abs(a - t),
                    r = l / c) : a > 0 && (a = o ? o / 2.5 * (c / 8) : 0,
                    l = Math.abs(t) + a,
                    r = l / c),
                    {
            ...
            n.prototype = {
                ...
                _move: function(t) {
                    if (this.enabled && a.eventType[t.type] === this.initiated) {
                        ...
                        !(c - this.endTime > 300 && 10 > n && 10 > o)) {
                            if (this.directionLocked || this.options.freeScroll || (this.directionLocked = n > o + this.options.directionLockThreshold ? "h" : o >= n + this.options.directionLockThreshold ? "v" : "n"),
                ...
                _end: function(t) {
                    if (this.enabled && a.eventType[t.type] === this.initiated) {
                        ...
                        a.getTime() - this.startTime), o = Math.round(this.x), s = Math.round(this.y), r = Math.abs(o - this.startX), l = Math.abs(s - this.startY), c = 0, u = "";
                        ...
                        !this.resetPosition(this.options.bounceTime))
                            ...
                            o != this.x || s != this.y ? ((o > 0 || o < this.maxScrollX || s > 0 || s < this.maxScrollY) && (u = a.ease.quadratic),
                            void this.scrollTo(o, s, c, u)) : void this._execEvent("scrollEnd")) : (this.options.tap && a.tap(t, this.options.tap),
                ...
                _animate: function(t, e, i, n) {
                    function o() {
                        ...
                        return m >= d ? (r.isAnimating = !1,
                        r._translate(t, e),
                        void (r.resetPosition(r.options.bounceTime) || r._execEvent("scrollEnd"))) : (m = (m - u) / i,
                        f = n(m),
                        h = (t - l) * f + l,
                        p = (e - c) * f + c,
                        r._translate(h, p),
    ...
    32: [function(t, e) {
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null
              ...
              , c = function(t, e) {
                this.options = o.extend({}, c.DEFAULTS, e || {}),
                this.$element = o(t),
            ...
            c.prototype.open = function(t) {
                ...
                if (!this.active && this.$element.length) {
                    ...
                    a.open(e),
                    e.show().redraw(),
                    n || this.isActions || (s && (s = parseInt(s, 10),
                    c.width = s + "px",
                    c.marginLeft = -parseInt(s / 2) + "px"),
                    r ? (r = parseInt(r, 10),
                    c.marginTop = -parseInt(r / 2) + "px",
                    this.$dialog.css({
                        height: r + "px"
                    })) : c.marginTop = -parseInt(e.height() / 2, 10) + "px",
                    e.css(c)),
            ...
            c.prototype.events = function() {
                ...
                this.options.cancelable && e.on("keyup.modal.amui", function(i) {
                    t.active && 27 === i.which && (e.trigger("cancel.modal.amui"),
                    t.close())
                }),
        ...
        (function(i) {
            ...
            function n(t, e) {
                return this.each(function() {
                    ...
                    n || (i.data("amui.offcanvas", n = new c(this,o)),
                    (!t || "object" == typeof t) && n.open(e)),
                    "string" == typeof t && n[t] && n[t](e)
                })
            }
            var o, s = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null , a = t("./core"), r = (t("./util.hammer"),
            s(window)), l = s(document), c = function(t, e) {
                this.$element = s(t),
            ...
            c.prototype.open = function() {
                ...
                if (e.length && !e.hasClass("am-active")) {
                    ...
                    this.active = 1,
                    e.on("click.offcanvas.amui", function(e) {
                        var i = s(e.target);
                        i.hasClass("am-offcanvas-bar") || i.parents(".am-offcanvas-bar").first().length || (e.stopImmediatePropagation(),
                        t.close())
                    }),
            ...
            c.prototype.close = function() {
                ...
                r.length && this.active && r.hasClass("am-active") && (r.trigger("close.offcanvas.amui"),
                a.support.transition ? (setTimeout(function() {
                    l.removeClass("am-offcanvas-bar-active")
                }, 0),
                n.css("margin-left", "").one(a.support.transition.end, function() {
                    t()
                }).emulateTransitionEnd(this.options.duration)) : t(),
                r.off("click.offcanvas.amui"),
                i.off(".offcanvas.amui"))
            }
            ,
    ...
    35: [function(t, e) {
        (function(i) {
            ...
            r.prototype.init = function() {
                ...
                e.appendTo(o("body")),
                this.sizePopover(),
                n.on("open.popover.amui", function() {
            ...
            r.prototype.sizePopover = function() {
                ...
                if (e && e.length) {
                    ...
                    r - g < d.top + g ? f = u.top - r - g : r < h - d.top - d.height ? (w = "bottom",
                    f = u.top + c + s + g) : (w = "middle",
                    f = c / 2 + u.top - n / 2),
                    "top" === w || "bottom" === w ? (m = l / 2 + u.left - i / 2,
                    v = m,
                    5 > m && (m = 5),
                    m + i > p && (m = p - i - 20),
            ...
            r.prototype.events = function() {
                for (var t = "popover.amui", e = this.options.trigger.split(" "), i = e.length; i--; ) {
                    var n = e[i];
                    if ("click" === n)
                        this.$element.on("click." + t, o.proxy(this.toggle, this));
                    else {
        ...
        (function(i) {
            ...
            function() {
                ...
                o.render = function(t) {
                    ...
                    a.showSpinner || (r = i.querySelector(a.spinnerSelector),
                    r && n(r).remove()),
                    d != document.body && n(d).addClass("nprogress-custom-parent"),
                    d.appendChild(i),
                    i
                }
                ,
        ...
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null
              ...
              , u = function(t, e) {
                ...
                this.options = o.extend({}, u.DEFAULTS, e),
            ...
            u.prototype.refreshSlides = function() {
                ...
                r && (1 === r && i.addClass(e.className.onlyOne),
                a.not("[" + l + "]").each(function(e, i) {
                    var a, r;
                    "A" === i.nodeName ? (a = i.href,
                    r = i.title || "") : (a = o(i).data("rel") || i.src,
                    r = o(i).attr("alt") || ""),
                    i.setAttribute(l, "1"),
                    t.imgUrls.push(a),
                ...
                i.find(e.selector.total).text(r),
                this.$slider.append(n),
                this.$nav.append(s),
            ...
            u.prototype.activate = function(t) {
                ...
                this.transitioning = 1,
                this.$title.text(a),
                this.$current.text(n + 1),
                i.removeClass(),
                t.addClass(r),
                i.eq(n - 1).addClass(e.className.prevSlide),
                i.eq(n + 1).addClass(e.className.nextSlide),
                this.$navItems.removeClass().eq(n).addClass(e.className.active),
                c ? t.one(c.end, o.proxy(function() {
                    this.transitioning = 0
            ...
            u.prototype.close = function() {
                ...
                c ? this.$pureview.one(c.end, o.proxy(t, this)).emulateTransitionEnd(300) : t.call(this)
            }
            ,
            ...
            a.prototype.process = function() {
                ...
                i.length) {
                    ...
                    if (o.each(i, function(e, i) {
                        return o(i).offset().top >= t ? (r = o(i),
                        !1) : void 0
                    }),
                    !r)
                        return;
                    e.closest ? (n.closest(e.closest).removeClass(e.className.active),
                    n.filter('a[href="#' + r.attr("id") + '"]').closest(e.closest).addClass(e.className.active)) : n.removeClass(e.className.active).filter('a[href="#' + r.attr("id") + '"]').addClass(e.className.active)
                }
            }
            ,
        ...
        (function(i) {
            ...
            function n(t) {
                return this.each(function() {
                    ...
                    (i || "destroy" !== t) && (i || e.data("amui.selected", i = new a(this,n)),
                    "string" == typeof t && i[t] && i[t]())
                })
            }
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null
            ...
            a.prototype.syncData = function(t) {
                ...
                t) {
                    ...
                    this.$originalOptions.not(s).prop("selected", !1);
        ...
        (function(i) {
            ...
            l.prototype.init = function() {
                if (!this.inited) {
                    ...
                    r.on("click.share.amui", e, n.proxy(function(t) {
                        ...
                        "mail" !== s && "sms" !== s && (t.preventDefault(),
                        this.shareTo(s, this.setData(s))),
                        this.close()
                    }, this)),
                    this.inited = !0
                }
            ...
            l.prototype.setData = function(t) {
                if (t) {
                    ...
                    if (o.test(t) && !n.length) {
                        for (var s = a.images, r = 0; r < s.length && 10 > r; r++)
                            !!s[r].src && n.push(encodeURIComponent(s[r].src));
                        this.pics = n
                    }
                    switch (t) {
                    case "qzone":
            ...
            l.prototype.shareTo = function(t, e) {
                ...
                if (i) {
                    ...
                    var n = [];
                    for (var o in e)
                        e[o] && n.push(o.toString() + "=" + ("pic" === o || "pics" === o ? e[o] : encodeURIComponent(e[o])));
        ...
        (function(i) {
            ...
            var n = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null
              ...
              , l = function(t, e) {
                ...
                function c(t) {
                    r && (u || (u = t),
                    d = Math.min(1, Math.max((t - u) / w, 0)),
                    h = Math.round(m + g * i(d)),
                    g > 0 && h > f && (h = f),
                    0 > g && f > h && (h = f),
                    v != h && p.scrollTop(h),
                    v = h,
    ...
    43: [function(t, e) {
        (function(i) {
            ...
            a.prototype.checkPosition = function() {
                ...
                !this.sticked && l ? s.addClass(r) : this.sticked && !l && this.reset(),
                this.$holder.height(s.is(":visible") ? s.height()+10 : 0), 
                l && s.css({
                    top: n,
        ...
        (function(i) {
            ...
            function n(t) {
                return this.each(function() {
                    ...
                    n || i.data("amui.tabs", n = new c(i[0],a)),
            ...
            c.prototype.open = function(t) {
                if (t && !this.transitioning && !t.parent("li").hasClass("am-active")) {
                    ...
                    t.trigger(c),
                    c.isDefaultPrevented() || (this.activate(t.closest("li"), e),
                    this.activate(r, n, function() {
                        t.trigger({
        ...
        (function(i) {
            ...
            function n(t) {
                return this.each(function() {
                    ...
                    (i || "destroy" !== t) && (i || e.data("amui.ucheck", i = new a(this,n)),
                    "string" == typeof t && i[t] && i[t](),
                    s.support.touch && e.parent().hover(function() {
    ...
    46: [function(t, e) {
        (function(i) {
            ...
            var o = "undefined" != typeof window ? window.jQuery : "undefined" != typeof i ? i.jQuery : null
              ...
              , a = function(t, e) {
                this.options = o.extend({}, a.DEFAULTS, e),
                this.options.patterns = o.extend({}, a.patterns, this.options.patterns);
                var i = this.options.locales;
                !a.validationMessages[i] && (this.options.locales = "zh_CN"),
                this.$element = o(t),
                this.init()
            };
            a.DEFAULTS = {
            ...
            a.prototype.init = function() {
                ...
                var i = this
                  , n = this.$element
                  , a = this.options;
                return a.H5validation && s.support.formValidation ? !1 : (n.attr("novalidate", "novalidate"),
                o.each(a.H5inputType, function(e, i) {
                ...
                e(".am-active", "keyup", 50),
                void e("textarea[maxlength]", "keyup", 50))
            }
            ,
            ...
            a.prototype.validate = function(t) {
                ...
                if (n.debug && window.console && (console.log("Validate: value -> [" + d + ", regex -> [" + l + "], required -> " + h),
                console.log("Regex test: " + l.test(d) + ", Pattern: " + r)),
                !isNaN(p) && d.length > p && (g.valid = !1,
                g.tooLong = !0),
                !isNaN(f) && d.length < f && (g.valid = !1,
                g.customError = "tooShort"),
                !isNaN(m) && Number(d) < m && (g.valid = !1,
                g.rangeUnderflow = !0),
                !isNaN(v) && Number(d) > v && (g.valid = !1,
                g.rangeOverflow = !0),
                h && !d)
                    g.valid = !1,
                    g.valueMissing = !0;
                    ...
                    !isNaN(w) && w > d && (g.valid = !1,
                    g.customError = "checkedUnderflow"),
                    !isNaN(y) && d > y && (g.valid = !1,
                    g.customError = "checkedOverflow")
                } else
                    r && !l.test(d) && d && (g.valid = !1,
                    g.patternMismatch = !0);
                var b, T = function(t) {
                    this.markField(t),
                ...
                if ("function" == typeof n.validate && (b = n.validate.call(this, g)),
                b) {
            ...
            a.prototype.isFormValid = function() {
                ...
                return e.valid ? (i("valid"),
                !0) : (e.$invalidFields.first().focus(),
                i("invalid"),
                !1)
            }
            ,
        ...
        (function(i) {
            ...
            var o = {
                get: function(t) {
                    ...
                    o = decodeURIComponent(document.cookie.substring(n + i.length, e))),
                    o
                },
                set: function(t, e, i, n, o, s) {
                    var a = encodeURIComponent(t) + "=" + encodeURIComponent(e);
                    i instanceof Date && (a += "; expires=" + i.toGMTString()),
                    n && (a += "; path=" + n),
                    o && (a += "; domain=" + o),
                    s && (a += "; secure"),
                    document.cookie = a
    ...
    48: [function(t, e) {
        (function(t) {
            ...
            function i(t, e) {
                ...
                !i.notNeeded(t)) {
                    for (var a = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], r = this, l = 0, c = a.length; c > l; l++)
                        r[a[l]] = n(r[a[l]], r);
            ...
            i.prototype.onTouchEnd = function(t) {
                ...
                "label" === n) {
                    ...
                    return t.timeStamp - i > 100 || a && window.top !== window && "input" === n ? (this.targetElement = null ,
                    !1) : (this.focus(u),
                    this.sendClick(u, t),
                    a && "select" === n || (this.targetElement = null ,
                    t.preventDefault()),
                    !1);
                return a && !r && (o = u.fastClickScrollParent,
                o && o.fastClickLastScrollTop !== o.scrollTop) ? !0 : (this.needsClick(u) || (t.preventDefault(),
                this.sendClick(u, t)),
                !1)
            }
            ,
            ...
            i.notNeeded = function(t) {
                ...
                if (c && (n = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/),
    ...
    49: [function(t, e) {
        (function(i) {
            ...
            a.VERSION = "2.0.0",
            n.AMUI.fullscreen = a,
            void (e.exports = a)) : void (e.exports = !1)
        }
        ).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }
    , {
    ...
    50: [function(t, e) {
        (function(i) {
            ...
            a.prototype.watch = function(t) {
                if (s && (t = n.extend({}, this.options, t),
                n.isFunction(t.done))) {
                    this.clearWatch();
            ...
            a.prototype.clearWatch = function() {
                s && this.watchID && (s.clearWatch(this.watchID),
                this.watchID = null )
            }
            ,
    ...
    51: [function(t, e) {
        (function(i) {
            ...
            function R(t, e) {
                ...
                return e & (Se | Ae) && (i = y(i.concat(n), "identifier", !0)),
                [i, n]
            }
            function U() {
                this.evTarget = Ye,
            ...
            function q(t, e) {
                ...
                for (o = 0; o < a.length; )
                    ...
                    e & (Se | Ae) && delete n[a[o].identifier],
                    o++;
            ...
            function ne(t, e) {
                return e = e || {},
                e.recognizers = d(e.recognizers, ne.defaults.preset),
                new oe(t,e)
            }
            function oe(t, e) {
                e = e || {},
            ...
            l(z, C, {
                handler: function(t) {
                    ...
                    e & ke && 1 !== t.which && (e = Se),
                    this.pressed && this.allow && (e & Se && (this.pressed = !1),
            ...
            window.MSPointerEvent && (We = "MSPointerDown",
            ...
            l(_, C, {
                handler: function(t) {
                    ...
                    o & Ee && (0 === t.button || a) ? 0 > r && (e.push(t),
                    r = e.length - 1) : o & (Se | Ae) && (i = !0),
                    0 > r || (e[r] = t,
            ...
            l(j, C, {
                handler: function(t) {
                    var e = He[t.type];
                    if (e === Ee && (this.started = !0),
                    this.started) {
                        var i = R.call(this, t, e);
                        e & (Se | Ae) && i[0].length - i[1].length === 0 && (this.started = !1),
                        this.callback(this.manager, e, {
                            pointers: i[0],
                            changedPointers: i[1],
                            pointerType: ye,
            ...
            Q.prototype = {
                ...
                dropRecognizeWith: function(t) {
                    return o(t, "dropRecognizeWith", this) ? this : (t = Y(t, this),
                ...
                canEmit: function() {
                    for (var t = 0; t < this.requireFail.length; ) {
                        if (!(this.requireFail[t].state & (ui | oi)))
                            return !1;
                        t++
                    }
                    return !0
                ...
                recognize: function(t) {
                    var e = a({}, t);
                    return u(this.options.enable, [this, e]) ? (this.state & (li | ci | ui) && (this.state = oi),
                    this.state = this.process(e),
                    void (this.state & (si | ai | ri | ci) && this.tryEmit(e))) : (this.reset(),
                    void (this.state = ui))
                },
                process: function() {},
            ...
            l(G, Z, {
                ...
                directionTest: function(t) {
                    var e = this.options
                      ...
                      , s = t.deltaX
                      , a = t.deltaY;
                    return o & e.direction || (e.direction & Ne ? (o = 0 === s ? De : 0 > s ? Fe : Me,
                    i = s != this.pX,
                    n = Math.abs(t.deltaX)) : (o = 0 === a ? De : 0 > a ? Pe : Ie,
                    i = a != this.pY,
                    n = Math.abs(t.deltaY))),
                    t.direction = o,
            ...
            l(K, Q, {
                ...
                process: function(t) {
                    ...
                    if (this._input = t,
                    !o || !i || t.eventType & (Se | Ae) && !s)
                        this.reset();
                    else if (t.eventType & Ee)
                        this.reset(),
                        this._timer = n(function() {
                            this.state = li,
                            this.tryEmit()
                        }, e.time, this);
                    else if (t.eventType & Se)
                        return li;
                    return ui
                },
                reset: function() {
                ...
                emit: function(t) {
                    this.state === li && (t && t.eventType & Se ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = pe(),
            ...
            l(ee, Z, {
                ...
                attrTest: function(t) {
                    ...
                    return i & (Ne | $e) ? e = t.velocity : i & Ne ? e = t.velocityX : i & $e && (e = t.velocityY),
                    this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && he(e) > this.options.velocity && t.eventType & Se
                },
                emit: function(t) {
                    var e = X(t.direction);
                    e && this.manager.emit(this.options.event + e, t),
        ...
        (function(i) {
            ...
            function o(t) {
                for (var e = [], i = 0; i < t.length; i++)
                    for (var o = t.charCodeAt(i), s = n(o), a = 0; a < s.length; a++)
                        e.push(s[a]);
                return e
            }
            function s(t, e) {
            ...
            var u = []
              , d = function(t) {
                ...
                if (i == n && (e = new s(this.options.text,this.options.correctLevel),
                u.push({
            ...
            s.prototype = {
                ...
                setupPositionProbePattern: function(t, e) {
                    for (var i = -1; 7 >= i; i++)
                        if (!(-1 >= t + i || this.moduleCount <= t + i))
                            for (var n = -1; 7 >= n; n++)
                                -1 >= e + n || this.moduleCount <= e + n || (this.modules[t + i][e + n] = i >= 0 && 6 >= i && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == i || 6 == i) || i >= 2 && 4 >= i && n >= 2 && 4 >= n ? !0 : !1)
                },
                    ...
                    for (var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++)
                        for (var i = 0; i < t.length; i++) {
                            ...
                            if (null == this.modules[n][o])
                                for (var s = -2; 2 >= s; s++)
                                    for (var a = -2; 2 >= a; a++)
                                        this.modules[n + s][o + a] = -2 == s || 2 == s || -2 == a || 2 == a || 0 == s && 0 == a ? !0 : !1
                        }
                },
                ...
                createBytes: function(t) {
                    for (var e = 0, i = 0, n = 0, o = this.rsBlock.length / 3, s = new Array, r = 0; o > r; r++)
                        for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], u = this.rsBlock[3 * r + 2], d = 0; l > d; d++)
                            s.push([u, c]);
                    for (var h = new Array(s.length), p = new Array(s.length), m = 0; m < s.length; m++) {
                        ...
                        n = Math.max(n, g),
                        h[m] = new Array(v);
                        for (var r = 0; r < h[m].length; r++)
                            h[m][r] = 255 & t.buffer[r + e];
                        e += v;
            ...
            for (var h = [1, 0, 3, 2], p = {
                ...
                getErrorCorrectPolynomial: function(t) {
                    for (var e = new a([1],0), i = 0; t > i; i++)
                        e = e.multiply(new a([1, m.gexp(i)],0));
                    return e
                },
                getLostPoint: function(t) {
                    for (var e = t.getModuleCount(), i = 0, n = 0, o = 0; e > o; o++)
                        for (var s = 0, a = t.modules[o][0], r = 0; e > r; r++) {
                            var l = t.modules[o][r];
                            if (e - 6 > r && l && !t.modules[o][r + 1] && t.modules[o][r + 2] && t.modules[o][r + 3] && t.modules[o][r + 4] && !t.modules[o][r + 5] && t.modules[o][r + 6] && (e - 10 > r ? t.modules[o][r + 7] && t.modules[o][r + 8] && t.modules[o][r + 9] && t.modules[o][r + 10] && (i += 40) : r > 3 && t.modules[o][r - 1] && t.modules[o][r - 2] && t.modules[o][r - 3] && t.modules[o][r - 4] && (i += 40)),
                            e - 1 > o && e - 1 > r) {
                                var c = 0;
                                l && c++,
                                t.modules[o + 1][r] && c++,
                ...
                multiply: function(t) {
                    for (var e = new Array(this.getLength() + t.getLength() - 1), i = 0; i < this.getLength(); i++)
                        for (var n = 0; n < t.getLength(); n++)
                            e[i + n] ^= m.gexp(m.glog(this.get(i)) + m.glog(t.get(n)));
                    return new a(e,0)
                },
                mod: function(t) {
                    ...
                    for (var n = new Array(e), o = 0; e > o; o++)
                        n[o] = this.get(o);
                    for (; n.length >= i; ) {
                        for (var s = m.glog(n[0]) - m.glog(t.get(0)), o = 0; o < t.getLength(); o++)
                            n[o] ^= m.gexp(m.glog(t.get(o)) + s);
                        for (; 0 == n[0]; )
                            n.shift()
                    }
                    return new a(n,0)
