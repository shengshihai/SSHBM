(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            for (var i = 0; i < num; i++) {
                $("div", oFocusContainer).append('<img src="/Content/KeYanBao/imgs/foo.png" />');
            }
            var oFocus = $("img", oFocusContainer);
            oFocusContainer.css({
            ...
            $("img", oFocusContainer).css({
                //display: 'block',
                //float: 'left',
                cursor: 'pointer'
            })
            $("div", oFocusContainer).css({//.width(oFocus.outerWidth(true) * num)
                width: '100%',
                position: 'absolute',
                right: 0,
                top: '50%',
                //marginTop: -$(this).find('img').width() / 2
            });
