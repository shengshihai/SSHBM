 ...
 *	<div name="rbt" class="checked" type="radiobox" val="cn"></div><span>中文</span>
...
;(function($){
	...
	var checkbox = {
		...
		toggle: function(e) {
			$(this).toggleClass('cb_active').children().attr('checked', ($(this).hasClass('cb_active') ? true : false)).get(0).checked = $(this).hasClass('cb_active');
