var Chart = function (s) {
    ...
    var G = function (a, c, b) {
              ...
              for (var g = 0; g < a.datasets.length; g++) {
                  ...
                  if (c.pointDot) {
                      ...
                      for (f = 0; f < a.datasets[g].data.length; f++)
                          ...
                          b.beginPath(),
                          b.arc(0, d * -1 *
                          v(a.datasets[g].data[f], j, k), c.pointDotRadius, 2 * Math.PI, !1),
                          b.fill(),
                          b.stroke()
                  }
                  b.rotate(e)
      ...
      , K = function (a, c, b) {
          ...
          for (f = 0; f < a.datasets.length; f++)
              for (l =
              0; l < a.datasets[f].data.length; l++)
          ...
          x(c, function () {
              ...
              for (var f = 0; f < a.datasets.length; f++) {
                  ...
                  for (var g = 1; g < a.datasets[f].data.length; g++)
                      c.bezierCurve ? b.bezierCurveTo(n + m * (g - 0.5), e(f, g - 1), n + m * (g - 0.5),
