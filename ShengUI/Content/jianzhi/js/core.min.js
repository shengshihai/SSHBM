function pageScroll() {
    ...
    0 == document.documentElement.scrollTop && 0 == document.body.scrollTop && ($("#backtop").css("background-position-x", "0"),
...
function placeholderFn() {
    placeholderSupport() || $("[placeholder]").focus(function () {
        ...
        var a = $(this);
        ("" == a.val() || a.val() == a.attr("placeholder")) && (a.addClass("placeholder"),
...
$(function () {
    ...
    $("#options dl dt").click(function () {
        $(this).parent().hasClass("slideUp") ? ($(this).children("em").removeClass("transform"),
        $(this).parent().children("dd").slideDown(200),
        $(this).parent().removeClass("slideUp").children("dd").slideDown(200)) : ($(this).children("em").addClass("transform"),
    ...
    $("#workplaceSelect .more").click(function (a) {
        ...
        $(this).siblings("#box_expectCity").hide()) : ($(this).addClass("open"),
