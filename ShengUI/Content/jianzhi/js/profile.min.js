...
function img_check(a, b, c) {
    ...
    $.ajaxFileUpload({
        ...
        success: function (a) {
            if (!a.IsError) {
                var b = a.Data;
                $("#portraitShow img").attr("src", b),
                $("#PORTRAIT").val(b),
                $("#basicInfo .basicShow img").attr("src",  b),
                $("#portraitNo").hide(),
                $("#portraitShow").show()
            } else
...
$(function () {
    ...
    $("#box_currentState").on("click", "ul li", function (a) {
        ...
        $("#CURRENT_STATE").val(v),
        $("#box_currentState").hide(),
        $("#profileForm").validate().element($("#CURRENT_STATE"))
    }),
    ...
    g = {
        ...
        Edit: function () {
            ...
            this.obj.children(".descriptionEdit").find(".word_count").children("span").text(100 - b.length),
            this.obj.children(".descriptionShow").addClass("dn"),
            this.obj.children(".descriptionEdit").removeClass("dn"),
    ...
    h = {
        ...
        Edit: function (a) {
            ...
            f.find(".workDescn").val(e),
            f.find(".word_count").children("span").text(100 - f.find(".workDesc").val().length),
            f.find(".showId").val(c),
