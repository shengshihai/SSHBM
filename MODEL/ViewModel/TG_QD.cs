...
namespace MODEL.ViewModel
{
    ...
    public partial class VIEW_TG_QD_P
    {
    ...
    public partial class VIEW_TG_QD:VIEW_TG_QD_P
    {
    
    
    
    	public static TG_QD ToEntity(VIEW_TG_QD model)
        {
           TG_QD item = new TG_QD();
       		item.Id=model.Id;
    	...
    	public static VIEW_TG_QD ToViewModel(TG_QD model)
        {
           VIEW_TG_QD item = new VIEW_TG_QD();
       		item.Id=model.Id;
    		item.userId=model.userId;
    		item.opneid=model.opneid;
    		item.ddTime=model.ddTime;
    	    ...
    	    public static IEnumerable<VIEW_TG_QD> ToListViewModel(IEnumerable<TG_QD> list)
            {
                var listModel = new List<VIEW_TG_QD>();
                foreach (TG_QD item in list)
                {
                    listModel.Add(VIEW_TG_QD.ToViewModel(item));
                }
                return listModel;
            }
