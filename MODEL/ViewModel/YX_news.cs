...
namespace MODEL.ViewModel
{
    ...
    public partial class VIEW_YX_news_P
    {
    ...
    public partial class VIEW_YX_news:VIEW_YX_news_P
    {
    
    
    
    	public static YX_news ToEntity(VIEW_YX_news model)
        {
           YX_news item = new YX_news();
       		item.Id=model.Id;
    	...
    	public static VIEW_YX_news ToViewModel(YX_news model)
        {
           VIEW_YX_news item = new VIEW_YX_news();
       		item.Id=model.Id;
    		item.EventId=model.EventId;
    		item.newsTitle=model.newsTitle;
    		item.newsDescription=model.newsDescription;
    	    ...
    	    public static IEnumerable<VIEW_YX_news> ToListViewModel(IEnumerable<YX_news> list)
            {
                var listModel = new List<VIEW_YX_news>();
                foreach (YX_news item in list)
                {
                    listModel.Add(VIEW_YX_news.ToViewModel(item));
                }
                return listModel;
            }
