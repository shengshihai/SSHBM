...
{
    [HandleError]
    public class AoShaCarController : BaseController
    {
        ...
        public ActionResult OrderList()
        {
            ...
            ViewBag.OrderList = VIEW_TG_order.ToListViewModel(orderB.GetListBy(s => s.UserId == userid && s.userOpenId == openid && s.trade_type == "ONLINE"&&s.SYNCOPERATION!="D", o => o.orderTime, false));
            return View();
        }
